const docs = [
    {
        id: 'introduction',
        files: ['docs/introduction/introduction.md'],
    },
    {
        id: 'getting-started',
        files: ['docs/getting-started/getting_started.md'],
    },
    {
        id: 'documentation',
        files: [
            'docs/documentation/reward_functions/reward_functions.md',
            'docs/documentation/reward_functions/common_rewards/common_reward_functions.md',
            'docs/documentation/reward_functions/common_rewards/ball_to_goal_rewards.md',
            'docs/documentation/reward_functions/common_rewards/conditional_rewards.md',
            'docs/documentation/reward_functions/common_rewards/misc_rewards.md',
            'docs/documentation/reward_functions/common_rewards/player_ball_rewards.md',
        ],
    },
    {
        id: 'tutorials',
    ...
    {
        id: 'faq',
        files: ['docs/faq/faq.md'],
    },
    {
        id: 'troubleshooting',
        files: ['docs/troubleshooting/troubleshooting.md'],
    },
];
...
function generateSectionNav(article) {
    let lastNav = document.querySelector(
        'a[href="#' + article.id + '"]'
    ).parentElement;
    ...
    for (let header of article.getElementsByTagName('h2')) {
        ...
        lastNav.insertAdjacentHTML(
            'afterend',
            '<li class="nav-item"><a class="nav-link scrollto" href="#' +
                header.id +
                '">' +
                header.innerText +
                '</a></li>'
...
function loadDocsAsync() {
    ...
    for (let article of docs) {
        ...
        articlePromises.push(
            Promise.all(articleContent).then(() =>
                generateSectionNav(articleElement)
            )
        );
    }
